    ...
    <div class="<?php wpp_css('property_overview::property_div', 'property_div' ); ?>">
      ...
      <div class="<?php wpp_css('property_overview::right_column', 'wpp_overview_right_column' ); ?>">
        <ul class="<?php wpp_css('property_overview::data', 'wpp_overview_data' ); ?>">
          ...
          <?php $expired_time = !empty( $property['wpp::feps::expired_time'] ) ? WPP_F::nice_time( $property['wpp::feps::expired_time'], 'format=date' ) : ''; ?>
          <li class="<?php wpp_css('property_overview::expired_date', "expired_date {$class}" ); ?>">
            <span class="title"><?php _e('Expired Date', 'wpp'); ?></span>
            <span class="doubledot">:</span>
          ...
          <li class="<?php wpp_css('property_overview::actions', 'actions' ); ?>">
            <ul>
              ...
              <li>
                <a class="<?php wpp_css('property_overview::button', 'denali-button button wpp_remove' ); ?>" href="<?php echo WPP_F::base_url( FEPS_VIEW_PAGE, array( 'feps' => $property['ID'], 'hash' => $property['wpp::feps::pending_hash'], 'action' => 'remove' ) ); ?>"><?php _e('Remove', 'wpp'); ?></a>
              </li>
            </ul>
          </li>
          <?php endif; ?>
