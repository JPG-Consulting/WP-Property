...
class WPP_List_Table extends WP_List_Table  {
  ...
  function __construct($args = '') {
    ...
    foreach($columns as $column_slug => $column_title) {
      ...
      $this->aoColumns[] = "{ 'sClass': '".str_replace(array('::',':','.'),'-',$column_slug)." column-".str_replace(array('::',':','.'),'-',$column_slug)."', 'bSortable':false}";
  ...
  function search_box( $text, $input_id ) {
    ...
    <p class="search-box">
      ...
      <input type="text" id="<?php echo $input_id ?>" name="wpp_search[post_title]" value="<?php _admin_search_query(); ?>" />
        ...
        wp_list_table = jQuery("#wp-list-table").dataTable({
          ...
          "fnServerData": function ( sSource, aoData, fnCallback ) {
            ...
            jQuery.ajax({
              ...
              "url": sSource,
              "data": aoData,
              "success": [fnCallback, admin_overview_init]
            });
          },
  ...
  /**
	...
	function print_column_headers( $with_id = true ) {
		...
		foreach ( $columns as $column_key => $column_display_name ) {
			$class = array( 'manage-column', "column-".str_replace(array('::',':','.'),'-',$column_key) );
			...
			$id = $with_id ? "id='".str_replace(array('::',':','.'),'-',$column_key)."'" : '';
